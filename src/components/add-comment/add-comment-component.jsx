...
const schema = yup.object().shape({
  ...
  const AddComment = props => {
    ...
    const onSubmitHandle = async (values, {setSubmitting}) => {
      ...
      productComment = {...values, user_email: currentEmail , user_firstName:currentFirstName, user_lastName:currentLastName ,product_id:productID};
  
      console.log("Ane manda Bn");
      console.log(currentEmail);
      console.log(productComment);

      setCommentDetails({...values, user_email: currentEmail , user_firstName:currentFirstName, user_lastName:currentLastName ,product_id:productID})
