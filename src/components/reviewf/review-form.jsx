                        ...
                        <div className="row">
                            ...
                            <div className="col-lg-8 product-details" key={selectedProduct._id}>
                                ...
                                <div className="p-review">
                                    <a href>3 reviews</a>|<a><span className="status-p" data-toggle="modal" data-target="#exampleModal"> Add your review </span></a>
                                </div>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-header">
                                                <h5 class="modal-title" id="exampleModalLabel">Your Review & Rating</h5>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div className="form-group">
                                                    ...
                                                    />
                                                    <br/>
                                                    <div className="p-rating" style={{marginLeft:"22%" ,marginRight:"22%"}}>
                                                        <label htmlFor="exampleFormControlTextarea1">Your Rating</label>
                                                        <ReactStars
                                                            size={50}
                                                            half={false}
                                            ...
                                            <div class="modal-footer fashion-buttons">
                                                ...
                                                <button type="submit" class="btn fashion-btn">Save Changes</button>
                                            </div>
                                            </form>
                                        </div>
                                    </div>
                                ...
                                <div id="accordion" className="accordion-area">
                                    ...
                                    <div className="panel" onClick={this.handleReviews.bind(this,selectedProduct._id)}>
                                        <div className="panel-header" id="headingTwo">
                                            <button className="panel-link" data-toggle="collapse"
                                                    data-target="#collapse2" aria-expanded="false"
                                                    aria-controls="collapse2">Ratings & Reviews
                                            </button>
                                        </div>
